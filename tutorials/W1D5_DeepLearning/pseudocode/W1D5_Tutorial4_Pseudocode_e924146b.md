# Pseudocode twin — W1D5 Tutorial 4: `decode_orientation`

- **Answer twin:** `../solutions/W1D5_Tutorial4_Solution_e924146b.py`
...
Blanks:
1. `net` — Initialize network
2. `loss_fn` — Initialize built-in PyTorch negative log likelihood loss function
