# W3D5 · Tutorial 3 · pseudocode companion
...
## Exercise 3.1 — `get_regression_estimate`
...
**Blanks:** `regression` (Initialize regression model with no intercept and alpha=0.01); `regression.fit(...)` (Fit regression to the data)

→ twin `pseudocode/W3D5_Tutorial3_Pseudocode_9134c469.md` · answer `solutions/W3D5_Tutorial3_Solution_9134c469.py`
