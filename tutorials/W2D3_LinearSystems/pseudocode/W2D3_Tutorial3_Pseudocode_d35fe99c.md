# Pseudocode twin — W2D3 Tutorial 3: `ddm`

- **Answer twin:** `../solutions/W2D3_Tutorial3_Solution_d35fe99c.py`
...
Blanks:
1. `analytical_variances` — fill in
2. `analytical_variances` — Hint: you can also do this in one line outside the loop!
