# Pseudocode twin — W2D3 Tutorial 1: `integrate_exponential`

- **Answer twin:** `../solutions/W2D3_Tutorial1_Solution_acf4095a.py`
...
Blanks:
1. `xdot` — for each point in time, compute xdot from x[k-1]
2. `x[k]` — Update x based on x[k-1] and xdot
