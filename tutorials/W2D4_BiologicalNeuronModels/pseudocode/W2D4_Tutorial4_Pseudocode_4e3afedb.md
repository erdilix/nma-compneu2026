# Pseudocode twin — W2D4 Tutorial 4: `generate_P`

- **Answer twin:** `../solutions/W2D4_Tutorial4_Solution_4e3afedb.py`
- **Reading view:** `../W2D4_Tutorial4_pseudocode.md`
...
Blanks:
1. `dP` — Calculate the delta increment dP
