# W1D2 · Tutorial 5 · pseudocode companion
...
**Blanks:** `mse_train` (fill in); `mse_test` (fill in)

→ twin `pseudocode/W1D2_Tutorial5_Pseudocode_bb5f169f.md` · answer `solutions/W1D2_Tutorial5_Solution_bb5f169f.py`
