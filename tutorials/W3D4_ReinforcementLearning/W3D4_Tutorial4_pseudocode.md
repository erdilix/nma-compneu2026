# W3D4 · Tutorial 4 · pseudocode companion
...
## Exercise 4.1 — `dyna_q_model_update`
...
→ twin `pseudocode/W3D4_Tutorial4_Pseudocode_69020143.md` · answer `solutions/W3D4_Tutorial4_Solution_69020143.py`

---

## Exercise 4.2 — `dyna_q_planning`
...
**Blanks:** `idx` (Write an expression for selecting a random row index from our candidates); `value` (Update the value function using Q-learning)

→ twin `pseudocode/W3D4_Tutorial4_Pseudocode_b99be074.md` · answer `solutions/W3D4_Tutorial4_Solution_b99be074.py`
