# Pseudocode twin — W3D3 Tutorial 1: `simulate_accuracy_vs_threshold`

- **Answer twin:** `../solutions/W3D3_Tutorial1_Solution_87825db1.py`
...
Blanks:
1. `decision_speed` — Calculate and store average decision speed and accuracy
2. `decision_accuracy` — fill in
