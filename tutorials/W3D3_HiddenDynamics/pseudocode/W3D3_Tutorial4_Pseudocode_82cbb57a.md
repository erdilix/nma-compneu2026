# Pseudocode twin — W3D3 Tutorial 4: `sample_lds`

- **Answer twin:** `../solutions/W3D3_Tutorial4_Solution_82cbb57a.py`
...
1. `state[t]` — fill in
2. `state[t]` — fill in
3. `obs[t]` — write the expression for computing the observation
