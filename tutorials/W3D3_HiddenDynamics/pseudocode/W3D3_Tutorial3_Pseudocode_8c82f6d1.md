# Pseudocode twin — W3D3 Tutorial 3: Set random seed

- **Answer twin:** `../solutions/W3D3_Tutorial3_Solution_8c82f6d1.py`
...
Blanks:
1. `todays_prior` — and broad it to account for the random change (i.e., add mean and variance of process noise).
2. `likelihood` — (i.e., multiply gaussians from today's prior and likelihood)
3. `info_posterior` — fill in
4. `posterior_mean` — fill in
