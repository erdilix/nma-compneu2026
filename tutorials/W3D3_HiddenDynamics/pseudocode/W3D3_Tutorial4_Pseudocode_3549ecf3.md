# Pseudocode twin — W3D3 Tutorial 4: `kalman_filter`

- **Answer twin:** `../solutions/W3D3_Tutorial4_Solution_3549ecf3.py`
...
Blanks:
1. `K` — write the expression for computing the Kalman gain
2. `mu[t]` — write the expression for computing the filtered state mean
3. `sigma[t]` — write the expression for computing the filtered state noise covariance
