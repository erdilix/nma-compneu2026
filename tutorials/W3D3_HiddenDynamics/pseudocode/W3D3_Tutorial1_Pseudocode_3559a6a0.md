# Pseudocode twin — W3D3 Tutorial 1: `simulate_SPRT_threshold`

- **Answer twin:** `../solutions/W3D3_Tutorial1_Solution_3559a6a0.py`
...
Blanks:
1. `evidence_history.append(...)` — STEP 2: accumulated evidence for this chunk
