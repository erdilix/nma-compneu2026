# Pseudocode twin — W3D3 Tutorial 2: `markov_forward`

- **Answer twin:** `../solutions/W3D3_Tutorial2_Solution_69ce2879.py`
...
Blanks:
1. `p1` — Calculate predictive probabilities (prior)
2. `posterior_t` — Calculate posterior
