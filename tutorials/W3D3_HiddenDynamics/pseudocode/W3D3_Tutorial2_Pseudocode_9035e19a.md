# Pseudocode twin — W3D3 Tutorial 2: `create_HMM`

- **Answer twin:** `../solutions/W3D3_Tutorial2_Solution_9035e19a.py`
- **Reading view:** `../W3D3_Tutorial2_pseudocode.md`
...
Blanks:
1. `transmat_mat` — STEP 1: Transition probabilities
2. `means_vec` — Mean measurements for each state
3. `transition_vector` — STEP 3: Get vector of probabilities for all possible `S[t]` given a particular `S[t-1]`
