# Pseudocode twin — W3D2 Tutorial 3: `calculate_binary_decision_array`

- **Answer twin:** `../solutions/W3D2_Tutorial3_Solution_fc2e7c22.py`
...
Blanks:
1. `idx` — find the position of mean in x_points (closest position)
