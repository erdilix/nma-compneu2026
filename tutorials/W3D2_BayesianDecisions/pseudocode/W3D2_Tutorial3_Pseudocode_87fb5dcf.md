# Pseudocode twin — W3D2 Tutorial 3: `my_Bayes_model_mse`

- **Answer twin:** `../solutions/W3D2_Tutorial3_Solution_87fb5dcf.py`
...
Blanks:
1. `marginal_nonzero` — Get the marginal likelihood corresponding to the action
